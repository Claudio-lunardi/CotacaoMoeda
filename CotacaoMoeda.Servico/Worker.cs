    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                await InserirCotacaoBancoDeDadosInterna(cotacao);
        ...
        private async Task InserirCotacaoBancoDeDadosInterna(Cotacao cotacao)
        {
            HttpResponseMessage retorno = await _httpClient.PostAsJsonAsync($"https://localhost:7264/api/Cotacao", cotacao);
